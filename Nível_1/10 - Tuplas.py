...
print(f"Quantidade de vezes que o elemento 2 aparece na tupla: ", Contagem) # Exibindo a contagem do número 2 na tupla
print(f"Quantidade de vezes que o elemento 2 aparece na tupla: ", minha_tupla.count(2)) # Contando quantas vezes o número 2 aparece na tupla

# Metodo index().
Indice = minha_tupla.index(3) # Encontrando o índice da primeira ocorrência do número 2 na tupla
print(f"Índice do elemento 3 na tupla: ", Indice) # Exibindo o índice do número 3 na tupla 
print(f"Índice do elemento 3 na tupla: ", minha_tupla.index(3)) # Encontrando o índice da primeira ocorrência do número 3 na tupla
